...
const resources = {
  en: {
    translation: {
      ...
      article_1_title: 'celebrates its premiere with updated design and technology',
      article_2_eyebrow: 'The new generation of the bestselling SUV', 
      article_2_title: `World premiere of the new`,
      article_3_title: 'Porsche Ukraine and Volkswagen donated 2 Volkswagen T-Cross cars and fuel to the blog organization SOS Children\'s Villages of Ukraine',
  ...
  uk: {
    translation: {
      ...
      article_1_title: 'відзначає прем’єру із оновленим дизайном та технологіями',
      article_2_eyebrow: 'Нове покоління SUV бестселлера', 
      article_2_title: `Світова прем\'єра нового`,
      article_3_title: 'Порше Україна та бренд Volkswagen передали 2 автомобілі Volkswagen T-Cross та пальне блогодійній організації СОС Дитячі Містечка України',
